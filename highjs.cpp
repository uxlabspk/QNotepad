...
highjs::highjs(QTextDocument *parent) : QSyntaxHighlighter(parent)
{
    ...
    keywordFormat.setForeground(Qt::darkCyan);
        ...
        const QString keywordPatterns[] = {
            ...
            QStringLiteral("\\bfunction\\b"), QStringLiteral("\\bvolatile\\b"), QStringLiteral("\\bbool\\b") ,
        ...
        for (const QString &pattern : keywordPatterns) {
            ...
            classFormat.setFontWeight(QFont::Bold);
                ...
                hash.setFontWeight(QFont::Bold);
                rule.pattern = QRegularExpression(QStringLiteral("async"));
                rule.format = hash;
                highlightingRules.append(rule);
                ...
                functionFormat.setForeground(Qt::blue);        //functions
...
void highjs::highlightBlock(const QString &text)
{
